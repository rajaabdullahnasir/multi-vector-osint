/**
 * AJAX company/domain footprint scan with full-page loader overlay.
 */
(function () {
  ...
  const LOADER_STEPS = [
    "Validating domain…",
    "Querying WHOIS org identity…",
    "Checking SPF / DMARC / DKIM…",
    "Reading HTTP response headers…",
    "Checking official platform presence…",
    "Building footprint report…",
  ];
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const form = document.querySelector("[data-org-footprint-form]");
    if (!form) {
      return;
    }
    ...
    const loader = new ScanLoader(document.getElementById("org-footprint-loader"));
