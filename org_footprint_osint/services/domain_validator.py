"""
Domain name validation for Company / Domain Footprint scans.
"""
...
# RFC 1035-style hostname labels; allows multi-level TLDs (e.g. co.uk).
DOMAIN_REGEX = (
    r"^(?=.{1,253}$)"
    r"(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\.)+"
    r"[a-zA-Z]{2,63}$"
)
# HTML5 pattern (no anchors; browser adds ^$)
DOMAIN_HTML_PATTERN = (
